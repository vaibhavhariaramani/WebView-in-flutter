...
class _WikipediaExplorerState extends State<WikipediaExplorer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('The Vaibhav Hariramani App'),
      ...
      body: WebView(
        initialUrl: 'https://sites.google.com/view/geeky-traveller/',
        ...
        return PopupMenuButton<String>(
          onSelected: (String value) async {
            if (value == 'Email link') {
              var url = await controller.data.currentUrl();
              await launch(
                  'mailto:?subject=Check out this cool blog by Geeky Traveller &body=$url');
            } else {
